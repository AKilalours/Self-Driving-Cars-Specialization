...
class PathOptimizer:
    ...
    # --- optimizer functions unchanged below ---
    ...
    def fxf(self, p):
        t2 = p[0]*(1.1E1/2.0); t3 = p[1]*9.0; t4 = p[2]*(9.0/2.0); t5 = p[0]*(9.0/2.0)
        t6 = p[1]*(2.7E1/2.0); t7 = p[2]*(2.7E1/2.0); t8 = p[3]*(9.0/2.0)
        t9 = t5-t6+t7-t8; t10 = p[0]*9.0; t11 = p[1]*(4.5E1/2.0); t12 = p[2]*1.8E1
        t13 = t8-t10+t11-t12; t14 = p[3]-t2+t3-t4
    ...
    def fxf_grad(self, p):
        ...
        t9 = t5-t6+t7-t8; t10 = p[0]*9.0; t11 = p[1]*(4.5E1/2.0); t12 = p[2]*1.8E1
        t13 = t8-t10+t11-t12; t14 = p[3]-t2+t3-t4
        t15 = p[0]*p[4]; t16 = p[0]*p[4]*(1.0/2.0); t17 = p[0]*p[4]*(3.0/4.0)
        t18 = p[0]*p[4]*(1.0/4.0); t19 = p[0]*p[4]*(3.0/8.0); t20 = p[0]*p[4]*(1.0/8.0)
        t21 = p[0]*p[4]*(5.0/8.0); t22 = p[0]*p[4]*(7.0/8.0)
        ...
        t9 = t5-t6+t7-t8; t10 = p[0]*9.0; t11 = p[1]*(4.5E1/2.0); t12 = p[2]*1.8E1
        t13 = t8-t10+t11-t12; t14 = p[3]-t2+t3-t4
        t15 = p[0]*p[4]; t16 = p[0]*p[4]*(1.0/2.0); t17 = p[4]*t14*(1.0/8.0)
        t18 = t16+t17-p[4]*t9*(1.0/6.4E1)-p[4]*t13*(1.0/2.4E1); t19 = p[0]*p[4]*(3.0/4.0)
        t20 = p[0]*p[4]*(1.0/4.0); t21 = p[4]*t14*(1.0/3.2E1)
        t22 = t20+t21-p[4]*t9*9.765625E-4-p[4]*t13*(1.0/1.92E2); t23 = p[0]*p[4]*(3.0/8.0)
        t24 = p[4]*t14*(9.0/1.28E2); t25 = t23+t24-p[4]*t9*4.94384765625E-3-p[4]*t13*(9.0/5.12E2)
        t26 = p[0]*p[4]*(1.0/8.0); t27 = p[4]*t14*(1.0/1.28E2)
        t28 = t26+t27-p[4]*t9*6.103515625E-5-p[4]*t13*6.510416666666667E-4
        t29 = p[0]*p[4]*(5.0/8.0); t30 = p[0]*p[4]*(7.0/8.0)
        ...
        t18 = p[0]*p[4]*(1.0/4.0); t19 = p[0]*p[4]*(3.0/8.0); t20 = p[0]*p[4]*(1.0/8.0)
        t21 = p[0]*p[4]*(5.0/8.0); t22 = p[0]*p[4]*(7.0/8.0)
        t23 = p[4]*(p[3]-t2+t3-t4)*(1.0/2.0); t39 = p[4]*t9*(1.0/4.0); t40 = p[4]*t13*(1.0/3.0)
        t24 = t15+t23-t39-t40; t25 = p[4]*(p[3]-t2+t3-t4)*(1.0/8.0)
        t41 = p[4]*t9*(1.0/6.4E1); t42 = p[4]*t13*(1.0/2.4E1); t26 = t16+t25-t41-t42
        t27 = p[4]*(p[3]-t2+t3-t4)*(1.0/3.2E1); t45 = p[4]*t9*9.765625E-4; t46 = p[4]*t13*(1.0/1.92E2)
        t28 = t18+t27-t45-t46; t29 = p[4]*(p[3]-t2+t3-t4)*(9.0/3.2E1)
        t43 = p[4]*t9*7.91015625E-2; t44 = p[4]*t13*(9.0/6.4E1); t30 = t17+t29-t43-t44
        t31 = p[4]*(p[3]-t2+t3-t4)*(1.0/1.28E2); t49 = p[4]*t9*6.103515625E-5
        t50 = p[4]*t13*6.510416666666667E-4; t32 = t20+t31-t49-t50
        t33 = p[4]*(p[3]-t2+t3-t4)*(9.0/1.28E2); t47 = p[4]*t9*4.94384765625E-3
        t48 = p[4]*t13*(9.0/5.12E2); t34 = t19+t33-t47-t48
        t35 = p[4]*(p[3]-t2+t3-t4)*(2.5E1/1.28E2); t51 = p[4]*t9*3.814697265625E-2
        t52 = p[4]*t13*8.138020833333333E-2; t36 = t21+t35-t51-t52
        t37 = p[4]*(p[3]-t2+t3-t4)*(4.9E1/1.28E2); t53 = p[4]*t9*1.4654541015625E-1
        t54 = p[4]*t13*2.233072916666667E-1; t38 = t22+t37-t53-t54
    ...
    def fyf_grad(self, p):
        ...
        t18 = p[0]*p[4]*(1.0/4.0); t19 = p[0]*p[4]*(3.0/8.0); t20 = p[0]*p[4]*(1.0/8.0)
        t21 = p[0]*p[4]*(5.0/8.0); t22 = p[0]*p[4]*(7.0/8.0)
        t23 = p[4]*t14*(1.0/2.0); t24 = t15+t23-p[4]*t9*(1.0/4.0)-p[4]*t13*(1.0/3.0)
        t25 = p[4]*t14*(1.0/8.0); t26 = t16+t25-p[4]*t9*(1.0/6.4E1)-p[4]*t13*(1.0/2.4E1)
        t27 = p[4]*t14*(9.0/3.2E1); t28 = t17+t27-p[4]*t9*7.91015625E-2-p[4]*t13*(9.0/6.4E1)
        t29 = p[4]*t14*(1.0/3.2E1); t30 = t18+t29-p[4]*t9*9.765625E-4-p[4]*t13*(1.0/1.92E2)
        t31 = p[4]*t14*(9.0/1.28E2); t32 = t19+t31-p[4]*t9*4.94384765625E-3-p[4]*t13*(9.0/5.12E2)
        t33 = p[4]*t14*(1.0/1.28E2); t34 = t20+t33-p[4]*t9*6.103515625E-5-p[4]*t13*6.510416666666667E-4
        t35 = p[4]*t14*(2.5E1/1.28E2); t36 = t21+t35-p[4]*t9*3.814697265625E-2-p[4]*t13*8.138020833333333E-2
        t37 = p[4]*t14*(4.9E1/1.28E2); t38 = t22+t37-p[4]*t9*1.4654541015625E-1-p[4]*t13*2.233072916666667E-1
        ...
        t28 = t26+t27-p[4]*t9*6.103515625E-5-p[4]*t13*6.510416666666667E-4
        t29 = p[0]*p[4]*(5.0/8.0); t30 = p[0]*p[4]*(7.0/8.0)
        t31 = p[4]*t14*(1.0/2.0); t32 = t15+t31-p[4]*t9*(1.0/4.0)-p[4]*t13*(1.0/3.0)
        t33 = p[4]*t14*(9.0/3.2E1); t34 = t19+t33-p[4]*t9*7.91015625E-2-p[4]*t13*(9.0/6.4E1)
        t35 = p[4]*t14*(2.5E1/1.28E2); t36 = t29+t35-p[4]*t9*3.814697265625E-2-p[4]*t13*8.138020833333333E-2
        t37 = p[4]*t14*(4.9E1/1.28E2); t38 = t30+t37-p[4]*t9*1.4654541015625E-1-p[4]*t13*2.233072916666667E-1
    ...
    def fbe_grad(self, p):
        grad = [0.0, 0.0, 0.0]
        grad[0] = p[4]*(p[0]*9.9E1+p[1]*6.48E2-p[2]*8.1E1-p[3]*3.6E1)*(1.0/8.4E2)
        grad[1] = p[4]*(p[0]*3.6E1+p[1]*8.1E1-p[2]*6.48E2-p[3]*9.9E1)*(-1.0/8.4E2)
        grad[2] = p[0]*p[1]*(3.3E1/2.8E2)-p[0]*p[2]*(3.0/7.0E1)+p[0]*p[3]*(1.9E1/8.4E2)-p[1]*p[2]*(2.7E1/2.8E2)-p[1]*p[3]*(3.0/7.0E1)+p[2]*p[3]*(3.3E1/2.8E2)+(p[0]*p[0])*(8.0/1.05E2)+(p[1]*p[1])*(2.7E1/7.0E1)+(p[2]*p[2])*(2.7E1/7.0E1)+(p[3]*p[3])*(8.0/1.05E2)
        return grad
